using DesignPattern.Comosite.CompositePattern;
using DesignPattern.Comosite.DAL;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace DesignPattern.Comosite.Controllers
{
    public class DefaultController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var values = Rekursive(categories, new Category { CategoryName = "FirstCategory", CategoryID = 0 }, new ProductComposite(0, "FirsComposite"));
